...
def construct_edges():
    ...
    # board.edges[0] = ([1, None], [8, None])

    # # First rows and columns
    # board.edges.append(Edge(0,1))
    # board.edges.append(Edge(1,2))
    # board.edges.append(Edge(2,3))
    # board.edges.append(Edge(3,4))
    # board.edges.append(Edge(4,5))
    # board.edges.append(Edge(5,6))

    # board.edges.append(Edge(0,8))
    # board.edges.append(Edge(2,10))
    # board.edges.append(Edge(4,12))
    # board.edges.append(Edge(6,14))

    # # Second rows and columns
    # board.edges.append(Edge(7,8))
    # board.edges.append(Edge(8,9))
    # board.edges.append(Edge(9,10))
    # board.edges.append(Edge(10,11))
    # board.edges.append(Edge(11,12))
    # board.edges.append(Edge(12,13))
    # board.edges.append(Edge(13,14))
    # board.edges.append(Edge(14,15))

    # board.edges.append(Edge(7,17))
    # board.edges.append(Edge(9,19))
    # board.edges.append(Edge(11,21))
    # board.edges.append(Edge(13,23))
    # board.edges.append(Edge(15,25))

    # # Third rows and columns
    # board.edges.append(Edge(16,17))
    # board.edges.append(Edge(17,18))
    # board.edges.append(Edge(18,19))
    # board.edges.append(Edge(19,20))
    # board.edges.append(Edge(20,21))
    # board.edges.append(Edge(21,22))
    # board.edges.append(Edge(22,23))
    # board.edges.append(Edge(23,24))
    # board.edges.append(Edge(24,25))
    # board.edges.append(Edge(25,26))

    # board.edges.append(Edge(16,27))
    # board.edges.append(Edge(18,29))
    # board.edges.append(Edge(20,31))
    # board.edges.append(Edge(22,33))
    # board.edges.append(Edge(24,35))
    # board.edges.append(Edge(26,37))

    # # Fourth rows and columns
    # board.edges.append(Edge(27,28))
    # board.edges.append(Edge(28,29))
    # board.edges.append(Edge(29,30))
    # board.edges.append(Edge(30,31))
    # board.edges.append(Edge(31,32))
    # board.edges.append(Edge(32,33))
    # board.edges.append(Edge(33,34))
    # board.edges.append(Edge(34,35))
    # board.edges.append(Edge(35,36))
    # board.edges.append(Edge(36,37))

    # board.edges.append(Edge(28,38))
    # board.edges.append(Edge(30,40))
    # board.edges.append(Edge(32,42))
    # board.edges.append(Edge(34,44))
    # board.edges.append(Edge(36,46))

    # # Fifth rows and columns
    # board.edges.append(Edge(38,39))
    # board.edges.append(Edge(39,40))
    # board.edges.append(Edge(40,41))
    # board.edges.append(Edge(41,42))
    # board.edges.append(Edge(42,43))
    # board.edges.append(Edge(43,44))
    # board.edges.append(Edge(44,45))
    # board.edges.append(Edge(45,46))

    # board.edges.append(Edge(39,47))
    # board.edges.append(Edge(41,49))
    # board.edges.append(Edge(43,51))
    # board.edges.append(Edge(45,53))

    # # Sixth rows and columns
    # board.edges.append(Edge(47,48))
    # board.edges.append(Edge(48,49))
    # board.edges.append(Edge(49,50))
    # board.edges.append(Edge(50,51))
    # board.edges.append(Edge(51,52))

    # board.edges.sort(key=lambda x: x.start)
